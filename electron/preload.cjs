...
contextBridge.exposeInMainWorld('electron', {
    ...
    startRemoteControlDrag: (point) => ipcRenderer.invoke('remote-control-drag-start', point),
    moveRemoteControlDrag: (point) => ipcRenderer.invoke('remote-control-drag-move', point),
    endRemoteControlDrag: () => ipcRenderer.invoke('remote-control-drag-end'),
